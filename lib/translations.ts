export const translations = {
  en: {
    ...
    settings: {
      ...
      aiModel: 'AI Model (StrAId)',
      aiModelDesc: 'Choose which language model to use for the assistant',
  ...
  fr: {
    ...
    settings: {
      ...
      leaflet: 'OpenStreetMap (Leaflet)',
      maplibre: 'MapLibre GL JS',
      aiModel: 'Modèle IA (StrAId)',
      aiModelDesc: 'Choisissez le modèle de langage pour l\'assistant',
